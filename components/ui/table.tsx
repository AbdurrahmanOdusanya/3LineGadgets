// ==============================================================================
// 3LINE GADGETS — UI PRIMITIVE: TABLE
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('border-b border-slate-200/80 bg-slate-50/80 text-xs text-slate-500 uppercase font-medium', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-slate-200 bg-slate-50 font-medium text-slate-900',
      className
    )}
    {...props}
  />
